...
async def handler(message: Message):
    ...
    if text == "📞 Aloqa":
        await message.answer("📞 HR telefon:\n+998 50 003 26 55", reply_markup=menu)
        return
    ...
    if step == "phone":
        ...
        await message.answer("💼 Qaysi lavozimga topshiryapsiz?", reply_markup=menu)
        return
    ...
    if step == "resume":
        ...
        await message.answer("✅ Arizangiz HR guruhga yuborildi!", reply_markup=menu)
